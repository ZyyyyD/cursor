...
export default function MoreScreen() {
  ...
  const categories = useMemo(() => {
    ...
    (customCategories ?? []).forEach((cat) => {
      ...
      if (!cats[name]) {
        cats[name] = { count: 0, value: 0, isCustom: true };
      }
    });
    ...
    (inventory ?? []).forEach((item) => {
      ...
      if (!cats[catName]) {
        cats[catName] = { count: 0, value: 0, isCustom: false };
      }
  ...
  const handleDeleteCategory = (categoryName) => {
    ...
    if (hasProducts) {
      Alert.alert(
        "Cannot Delete",
        "This category has products assigned to it. Remove or reassign the products first.",
      );
      return;
    }
    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            setCustomCategories(
              customCategories.filter((cat) => cat.name !== categoryName),
            );
    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Delete",
          style: "destructive",
          onPress: () => setSuppliers(suppliers.filter((s) => s.id !== id)),
        },
      ],
    );
  };
    ...
    <Screen>
          ...
          <View style={styles.modalContent}>
            ...
            <Card style={styles.summaryCard}>
              ...
              <View style={styles.summaryRow}>
                ...
                <Text style={styles.summaryValue}>
                  ₱{exportSummary.totalSales.toLocaleString()}
                </Text>
              </View>
            </Card>
            ...
            <Pressable
              ...
              onPress={() => handleExport("Inventory Data")}
            >
              <View
                style={[
                  styles.exportIcon,
            ...
            <Pressable
              style={styles.exportOption}
              onPress={() => handleExport("Sales Report")}
            >
              <View
                style={[
                  styles.exportIcon,
              ...
              <View style={styles.exportOptionText}>
                ...
                <Text style={styles.exportOptionDesc}>
                  Export all transactions and sales data
                </Text>
              </View>
              <Icon name="download" size={18} color={colors.primary} />
            </Pressable>
            ...
            <Pressable
              style={styles.exportOption}
              onPress={() => handleExport("Full Report")}
            >
              <View
                style={[
                  styles.exportIcon,
              ...
              <View style={styles.exportOptionText}>
                ...
                <Text style={styles.exportOptionDesc}>
                  Export everything (inventory + sales)
                </Text>
              </View>
              <Icon name="download" size={18} color={colors.primary} />
            </Pressable>
              ...
              {categories.length === 0 ? (
                ...
                categories.map((cat, index) => (
                  <View
                    ...
                    style={[
                      styles.listItem,
                      index < categories.length - 1 && styles.listItemBorder,
                    ]}
                  >
                    <View
                      style={[
      ...
      >
        ...
        >
          <Pressable
            style={styles.modalDismiss}
            onPress={() => setSuppliersModalVisible(false)}
          />
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
            ...
            >
              {suppliers.map((supplier, index) => (
                <View
                  ...
                  style={[
                    styles.listItem,
                    index < suppliers.length - 1 && styles.listItemBorder,
                  ]}
                >
                  <View
                    style={[
            ...
            >
              {locations.map((location, index) => (
                <View
                  ...
                  style={[
                    styles.listItem,
                    index < locations.length - 1 && styles.listItemBorder,
                  ]}
                >
                  <View
                    style={[
            ...
            <ScrollView style={styles.listContainer}>
              {units.map((unit, index) => (
                <View
                  ...
                  style={[
                    styles.listItem,
                    index < units.length - 1 && styles.listItemBorder,
                  ]}
                >
                  <View
                    style={[
            ...
            <ScrollView style={styles.listContainer}>
              {users.map((user, index) => (
                <View
                  ...
                  style={[
                    styles.listItem,
                    index < users.length - 1 && styles.listItemBorder,
                  ]}
                >
            ...
            <ScrollView style={styles.listContainer}>
              {auditLogs.map((log, index) => (
                <View
                  ...
                  style={[
                    styles.auditItem,
                    index < auditLogs.length - 1 && styles.listItemBorder,
                  ]}
                >
                  <View
                    style={[
                  ...
                  >
                    <Icon
                      name={log.type === "success" ? "check-circle" : "info"}
                      size={16}
                      color={
                        log.type === "success" ? colors.success : colors.info
                      }
                    />
                  </View>
